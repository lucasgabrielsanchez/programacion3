...
class Archivo 
{
	...
	public static function Guardar($obj)
    {
        ...
        //ABRO EL ARCHIVO
        $ar = fopen("clientes/clientesactiales.txt", "a");
	...
	public static function TraerListaClientes()
	{
		...
		$archivo=fopen("clientes/clientesactiales.txt", "r");
		...
		while(!feof($archivo))
		{
			...
			if ($archAux != false) 
			{
				...
				$clientes[4] = trim($clientes[4]);

				if($clientes[0] != "")
				{				
					$ListaDeClientes[] = (new Cliente($clientes[0], $clientes[1],$clientes[2],$clientes[3],$clientes[4]));
				}
			} 
		}
	...
	{
		unlink("clientes/clientesactiales.txt");
