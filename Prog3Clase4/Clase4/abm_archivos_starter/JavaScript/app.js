...
(function (Main) {
    ...
    function MostrarGrilla() {
        ...
        ajax.Post("http://localhost:8080/programacion3-master/Prog3Clase4/Clase4/abm_archivos_starter/administracion.php", MostrarGrillaSuccess, parametros, Fail);
    }
    ...
    function EliminarProducto(codBarra) {
        ...
        ajax.Post("http://localhost:8080/programacion3-master/Prog3Clase4/Clase4/abm_archivos_starter/administracion.php", DeleteSuccess, parametros, Fail);
    }
